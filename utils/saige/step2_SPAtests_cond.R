...
option_list <- list(
  ...
  make_option("--condition_file", type="character",default="",
    help="For conditional analysis (file). Variant ids are in the format chr:pos_ref/alt and seperated by by comma. e.g.chr3:101651171_C/T,chr3:101651186_G/A"),
