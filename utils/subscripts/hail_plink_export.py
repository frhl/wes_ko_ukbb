...
def main(args):
    ...
    # run parser
    hail_init(chrom)
    mt1 = get_table(input_path=input_path, input_type=input_type) # 12788
    mt1 = remake_rsid(mt1)
    ...
    if out_prefix is not None:
        export_table(mt1, out_prefix, out_type)
...
if __name__=='__main__':
    ...
    parser.add_argument('--vep_path', default=None, help='set path to VEP')
    # filtering variants
