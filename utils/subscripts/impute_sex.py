...
# Outputs
IMPUTESEX_TABLE = '/well/lindgren/UKBIOBANK/flassen/wes_' + TRANCHE + '/ukb_wes_qc/data/samples/04_imputesex.ht'
IMPUTESEX_FILE = '/well/lindgren/UKBIOBANK/flassen/wes_' + TRANCHE + '/ukb_wes_qc/data/samples/04_imputesex.tsv.bgz'
Y_NCALLED = '/well/lindgren/UKBIOBANK/flassen/wes_' + TRANCHE + '/ukb_wes_qc/data/samples/04_ycalled.tsv.bgz'
