...
def main(args):
    ...
    if liftover:
        ...
        mt = mt.checkpoint(out_prefix + "_liftover.mt")
    ...
    if input_path and input_type:
        ...
        mt = mt.checkpoint(out_prefix + "_filter_rows_by_mt2.mt")
        ...
        mt = mt.checkpoint(out_prefix + "_union_rows.mt")
    ...
    if min_mac:
        ...
        mt = mt.checkpoint(out_prefix + "_min_mac.mt")
    if missing:
        mt = filter_missing(mt, float(missing))
        mt = mt.checkpoint(out_prefix + "missing.mt")
