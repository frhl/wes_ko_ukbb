...
#SBATCH --job-name=cram_phase
#SBATCH --chdir=/well/lindgren-ukbb/projects/ukbb-11867/flassen/projects/KO/wes_ko_ukbb
#SBATCH --output=logs/cram_phase.log
#SBATCH --error=logs/cram_phase.errors.log
...
readonly out_file="${out_dir}/ukb_eur_wes_200k_chr${chr}_phased.vcf"
