...
readonly in_file="${in_dir}/ukb_calls_500k_chr${chr}.vcf.bgz"
readonly out_file="${out_dir}/short_ukb_calls_500k_chr${chr}.vcf.gz"
readonly ser_file="${out_dir}/short_ukb_calls_500k_chr${chr}.txt"
