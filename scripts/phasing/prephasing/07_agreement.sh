...
readonly input_dir="data/prephased/wes_union_calls/phase_conf" # chrom 20-22 200k samples
...
readonly out_prefix="${out_dir}/ukb_shapeit5_whatshap_phasing_agreement"
