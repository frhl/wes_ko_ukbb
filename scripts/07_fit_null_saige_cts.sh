...
readonly grm_mtx="${grm_dir}/211105_ukb_wes_200k_sparse_autosomes_females_relatednessCutoff_0.125_1000_randomMarkersUsed.sparseGRM.mtx"
...
# output path
readonly out_prefix="${out_dir}/ukb_wes_200k_females_${phenotype}"
