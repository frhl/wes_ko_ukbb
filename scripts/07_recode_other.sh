...
readonly out_dir="data/knockouts/alt/pp90/recoded_other_by_merge"
...
submit_recoding() {
  ...
  local input_path="${in_dir}/ukb_eur_wes_200k_chr${chr}_${csqs}_all.tsv.gz"
  set_up_rpy
  Rscript ${rscript} \
...
submit_recoding "synonymous"
#submit_recoding "other_missense"
