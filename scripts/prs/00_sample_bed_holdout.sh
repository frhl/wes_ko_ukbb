#!/usr/bin/env bash
#
#$ -N sample_bed_holdout
#$ -wd /well/lindgren-ukbb/projects/ukbb-11867/flassen/projects/KO/wes_ko_ukbb
#$ -o logs/sample_bed_holdout.log
#$ -e logs/sample_bed_holdout.errors.log
#$ -P lindgren.prjc
#$ -pe shmem 3
#$ -q long.qc@@long.hga
#$ -t 22
...
readonly out_dir="data/prs/validation/hapmap/unrel_eur_10k_seed1991"
