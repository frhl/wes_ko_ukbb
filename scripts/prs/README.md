...
| -                                 | -                                             | - |
| `00_bed_gen.sh` | 1. Load imputed genotypes or regular non-imputed genotypes. </br> 2. Subset to defined samples. </br> 3. Liftover to GRCh38 if needed. </br> 4. Write plink (.bed) output files.  | N/A |
