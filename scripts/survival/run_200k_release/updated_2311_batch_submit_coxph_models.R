...
submission_script <- "/well/lindgren-ukbb/projects/ukbb-11867/flassen/projects/KO/wes_ko_ukbb/scripts/survival/run_original/submit_coxph_models.sh"
...
print(paste("gene_chunks=",gene_chunks))
