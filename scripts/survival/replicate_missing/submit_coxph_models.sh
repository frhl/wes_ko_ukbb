...
Rscript /well/lindgren-ukbb/projects/ukbb-11867/flassen/projects/KO/wes_ko_ukbb/scripts/survival/replicate_missing/updated_2311_subset_run_coxph_models.R \
--geneNames=${geneNames} \
--chunk=${chunk} \
--fileType=${fileType} \
--refGroup=${refGroup}
