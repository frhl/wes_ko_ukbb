...
readonly rscript="scripts/conditional/rare/02_ld_by_phenotypes.R"
...
readonly out_prefix_cts="${out_dir}/ukb_eur_wes_200k_chr${chr}_maf0to5e-2_pLoF_damaging_missense_LD_cts"
readonly out_prefix_bin="${out_dir}/ukb_eur_wes_200k_chr${chr}_maf0to5e-2_pLoF_damaging_missense_LD_bin"
readonly out_prefix_combined="${out_dir}/ukb_eur_wes_200k_chr${chr}_maf0to5e-2_pLoF_damaging_missense_LD"
