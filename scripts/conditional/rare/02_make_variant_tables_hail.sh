#!/usr/bin/env bash
#
#$ -N test_prefilter_phenotypes
#$ -wd /well/lindgren-ukbb/projects/ukbb-11867/flassen/projects/KO/wes_ko_ukbb
#$ -o logs/test_prefilter_phenotypes.log
#$ -e logs/test_prefilter_phenotypes.errors.log
#$ -P lindgren.prjc
#$ -pe shmem 4
#$ -q short.qa
#$ -t 1-22
...
readonly pyscript="scripts/conditional/rare/02_prefilter_phenotypes.py"

readonly chr="${SGE_TASK_ID}"
readonly pheno_dir="data/phenotypes"
readonly in_dir="data/conditional/rare/combined"
readonly out_dir="data/conditional/rare/combined/hail_ac"
...
readonly covar_list="${pheno_dir}/covars1.csv"
...
submit_qc_job() {
  ...
  local covar_list_csv=$(cat ${covar_list})

  set_up_hail
  set_up_pythonpath_legacy
  python "${pyscript}" \
    --phenotypes ${pheno_list_csv} \
    --covariates ${covar_list_csv} \
