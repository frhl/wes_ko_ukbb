...
| `03_spa_conditional.sh` | 1. Load genotype VCFs and apply SPA using the null models from primary analysis. </br> Loop over markers and select most significant marker if it passes the SPA P-value threshold of P-value<=10e-6. </br> Condition on this marker and repeat analysis. </br> Continue repetating untill no markers are significant at the threshold given. </br> Save conditioning markers. | `02_filter_genotypes.sh` |
