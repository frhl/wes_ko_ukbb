...
readonly rscript_rare="scripts/conditional/combined/_spa_cond_everything.R"
...
readonly markers_rare_by_gene=${10?Error: Missing arg10 (markers_rare_ac)}
