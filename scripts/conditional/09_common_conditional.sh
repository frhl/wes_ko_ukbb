...
readonly out_dir="data/saige/output/conditional/binary/step1"
...
ource utils/bash_utils.sh

source utils/hail_utils.sh

readonly spark_dir="data/tmp/spark"
readonly out_dir="data/saige/conditional"

readonly in_grm=""
readonly final_sample_list='/well/lindgren/UKBIOBANK/dpalmer/wes_200k/ukb_wes_qc/data/samples/09_final_qc.keep.sample_list'

readonly out_prefix="${out_dir}/ukb_genotypes_200k"

readonly hail_script="scripts/09"
readonly threads=$(( ${NSLOTS}-1 ))
#readonly createSparseGRM="/well/lindgren/flassen/software/dev/SAIGE/extdata/createSparseGRM.R"
