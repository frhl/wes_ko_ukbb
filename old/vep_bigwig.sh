...
#export PERL5LIB=/well/lindgren/flassen/software/VEP/plugins_grch38/:$PERL5LIB #LOFTEE LIB
#export PERL5LIB=/well/lindgren/flassen/software/VEP/plugins_grch38/loftee:$PERL5LIB #dbNSFP
#export PERL5LIB=$PERL5LIB:/well/lindgren/flassen/software/VEP/vep_plugins/loftee

LOFTEE_PATH='/well/lindgren/flassen/software/VEP/plugins/loftee_grch38/loftee'
PERL5LIB=$PERL5LIB:$LOFTEE_PATH
...
--plugin LoF,loftee_path:/${LOFTEE_PATH},\
